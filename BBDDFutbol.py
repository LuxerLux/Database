...
def crear_Tabla(tabla):
    futbol = mydb.cursor()
    crearTabla= "CREATE TABLE {}".format(tabla)
...
def main():
    ...
    opcion='0'
    while opcion !='G': ###G es porque se sale segun esta puesto en el menu
        print(menu)
        opcion = input("\n¿Que opción deseas?\n").upper()
        ...
        ###Crear tabla
            ...
            print("\nNo pongas el mismo nombre a la tabla:")
            ver_tablas()
